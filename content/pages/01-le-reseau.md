...
Les cancers digestifs de mauvais pronostic représentent chaque année **plusieurs dizaines de milliers de nouveaux cas en France** et restent parmi les cancers les plus difficiles à traiter. Ils sont souvent **diagnostiqués à un stade avancé** : le taux de survie à 5 ans est de 11 % pour le cancer du pancréas, et de 18 % pour l'œsophage et le foie.   
...
Renforcer la collaboration entre les différents professionnels impliqués dans la prise en charge afin de proposer un parcours coordonné, personnalisé et adapté aux besoins de chaque patient, en intégrant les soins de support à toutes les étapes.      
  
📢 **Diffusion de l’information**   
Mettre à disposition des patients, des proches et des professionnels une information fiable, claire et actualisée sur les pathologies, les traitements, les essais cliniques et le parcours de soins, afin de favoriser une meilleure compréhension et une prise de décision éclairée.   
...
Les centres experts sont sélectionnés selon des **critères d'excellence**, parmi lesquels une expertise reconnue, une file active importante de patients, un accès aux essais cliniques innovants et une activité scientifique de haut niveau.   
...
- Garantir l’indépendance scientifique du réseau   
- Proposer des indicateurs d’évaluation   
